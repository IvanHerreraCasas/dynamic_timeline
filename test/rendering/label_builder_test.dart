...
void main() {
  group('label_builder tests', () {
    test('Test creation by factory fromString '
    ...
    test('Test creation of labels by "create" function 2 days with day interval '
      ...
      final builder = LabelBuilder.fromString((date) => 'TEST_123');
      final labels = builder.create(DateTime(2023,1,1), DateTime(2023,1,3), const Duration(days: 1));
